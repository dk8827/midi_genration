...
class GenerateMidiCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        print(f"Callback: Raw generated sequence for epoch {epoch+1}: {generated_sequence}")
        ...
        if generated_sequence:
            ...
            if midi_written_successfully:
                ...
                print(f"Callback: Sample MIDI for epoch {epoch+1} was generated by the writer: {output_midi_file}")
            else:
                # The MidiFileWriter prints detailed reasons if it fails to write or deems the content empty.
                print(f"Callback: INFO - MIDI file for epoch {epoch+1} ('{output_midi_file}') was not generated or was deemed empty by the MIDI writer. See writer logs for details.")
        else:
            print(f"Callback: MIDI generation failed prior to writer, no sequence produced for epoch {epoch+1}.") 